...
(function() {
    ...
    function createEmbedBlock(attachmentBlock) {
        ...
        embedBlock.setAttribute('style', '--color-background: #ffffff; box-shadow: rgb(255, 255, 255) 0px 1px 0px; padding-bottom: 4rem; padding-top: 4rem;');
        embedBlock.innerHTML = `
            <span></span>
            <div>
                <div class="animated fadeIn"
                     style="animation-duration: 0.75s; opacity: 1; animation-delay: 0s; animation-fill-mode: forwards;">
                    <div class="block-embed__wrapper block-embed__wrapper--medium" style="max-width: 800px;">
                        <section class="block-embed__item block-card bg--range-light block-card--white">
                            <div aria-hidden="false" aria-label="Embedded media player" class="embed" role="group">
                                <div class="embed--iframe">
                                    <iframe title="shivak PDF Viewer" src="${attachmentLink}" style="width: 100%; height: 600px;"></iframe>
                                </div>
                            </div>
                        </section>
                    </div>
